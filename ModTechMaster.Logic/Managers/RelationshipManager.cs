namespace ModTechMaster.Logic.Managers
{
    ...
    public class RelationshipManager
    {
            ...
            {
                {
                    ObjectType.Mod, new List<IObjectRelationship>
                    {
                        new ObjectRelationship(
                            ObjectType.Mod, ObjectType.Mod,
                            Keywords.DependsOn, Keywords.Name, true),
                        new ObjectRelationship(
                            ObjectType.Mod, ObjectType.Dll,
                            Keywords.Dll, Keywords.Name)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.PilotDef, ObjectType.AbilityDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.AmmunitionBoxDef, ObjectType.AmmunitionDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.WeaponDef, ObjectType.AmmunitionDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.WeaponDef,
                            Keywords.WeaponDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.UpgradeDef,
                            Keywords.UpgradeDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.HeatSinkDef,
                            Keywords.HeatSinkDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.JumpJetDef,
                            Keywords.JumpJetDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.AmmunitionBoxDef,
                            Keywords.AmmoBoxId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.MechDef, ObjectType.ChassisDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.ChassisDef, ObjectType.MovementCapabilitiesDef,
                            Keywords.MovementCapDefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.ChassisDef, ObjectType.PathingCapabilitiesDef,
                            Keywords.PathingCapDefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.ChassisDef, ObjectType.HardpointDataDef,
                            Keywords.HardpointDataDefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.ChassisDef, ObjectType.Prefab,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.VehicleDef, ObjectType.WeaponDef,
                            Keywords.WeaponDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.VehicleDef, ObjectType.AmmunitionBoxDef,
                            Keywords.AmmoBoxId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.VehicleDef, ObjectType.VehicleChassisDef,
                            Keywords.ChassisId, Keywords.Id)
                    }
                },
                {
                    ObjectType.VehicleChassisDef, new List<IObjectRelationship>
                    {
                        ...
                        new ObjectRelationship(
                            ObjectType.VehicleChassisDef, ObjectType.HardpointDataDef,
                            Keywords.HardpointDataDefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.VehicleChassisDef, ObjectType.Prefab,
                            Keywords.PrefabId, Keywords.Id)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.TurretDef, ObjectType.WeaponDef,
                            Keywords.WeaponDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.TurretDef, ObjectType.AmmunitionBoxDef,
                            Keywords.AmmoBoxId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.TurretDef, ObjectType.TurretChassisDef,
                            Keywords.ChassisId, Keywords.Id)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.TurretChassisDef, ObjectType.HardpointDataDef,
                            Keywords.HardpointDataDefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.TurretChassisDef, ObjectType.Prefab,
                            Keywords.PrefabId, Keywords.Id)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.Prefab, ObjectType.AssetBundle,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.CCDefaults, ObjectType.CCCategories,
                            Keywords.CategoryId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.CCDefaults, ObjectType.UpgradeDef,
                            Keywords.DefId, Keywords.Id),
                        new ObjectRelationship(
                            ObjectType.CCDefaults, ObjectType.HeatSinkDef,
                            Keywords.DefId, Keywords.Id)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.UpgradeDef, ObjectType.UpgradeDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.StreamingAssetsData, ObjectType.AbilityDef,
                            Keywords.AbilityDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.StreamingAssetsData, ObjectType.MechDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.CastDef,
                            Keywords.CastDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.DialogBucketDef,
                            Keywords.DialogBucketId, Keywords.Id, false),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.LanceDef,
                            Keywords.LanceDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.HeraldryDef,
                            Keywords.HeraldryDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.MechDef,
                            Keywords.MechDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.PilotDef,
                            Keywords.PilotId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.TurretDef,
                            Keywords.TurretId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ContractOverride, ObjectType.VehicleDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.CastDef, ObjectType.FactionDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.ConversationContent, ObjectType.DialogBucketDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.DialogBucketDef, ObjectType.CastDef,
                            Keywords.CastDefId, Keywords.Id, true)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.FlashpointDef, ObjectType.SimGameMilestoneSet,
                            Keywords.MilestoneSetId, Keywords.Id, false),
                        new ObjectRelationship(
                            ObjectType.FlashpointDef, ObjectType.ItemCollectionDef,
                            Keywords.ItemCollectionId, Keywords.Id, false),
                        new ObjectRelationship(
                            ObjectType.FlashpointDef, ObjectType.CastDef,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.HeraldryDef, ObjectType.Texture2D,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.MechDef,
                            Keywords.MechDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.UpgradeDef,
                            Keywords.UpgradeDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.ItemCollectionDef,
                            Keywords.ItemCollectionId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.WeaponDef,
                            Keywords.WeaponDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.HeatSinkDef,
                            Keywords.HeatSinkDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.AmmunitionBoxDef,
                            Keywords.AmmoBoxId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ItemCollectionDef, ObjectType.JumpJetDef,
                            Keywords.JumpJetDefId, Keywords.Id, true)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.SimGameMilestoneSet, ObjectType.SimGameMilestoneDef,
                            Keywords.MilestoneId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.SimGameMilestoneSet, ObjectType.ContractOverride,
                            Keywords.ContractId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.SimGameMilestoneSet, ObjectType.SimGameEventDef,
                            Keywords.EventId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.SimGameMilestoneSet, ObjectType.ItemCollectionDef,
                            Keywords.ItemCollectionId, Keywords.Id, true)
                    }
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.HardpointDataDef, ObjectType.Prefab,
                ...
                },
                {
                    ...
                    {
                        new ObjectRelationship(
                            ObjectType.ShopDef, ObjectType.WeaponDef,
                            Keywords.WeaponDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ShopDef, ObjectType.UpgradeDef,
                            Keywords.UpgradeDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ShopDef, ObjectType.MechDef,
                            Keywords.MechDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ShopDef, ObjectType.HeatSinkDef,
                            Keywords.HeatSinkDefId, Keywords.Id, true),
                        new ObjectRelationship(
                            ObjectType.ShopDef, ObjectType.JumpJetDef,
                            Keywords.JumpJetDefId, Keywords.Id, true)
                    }
                }
            };
        ...
        {
            return RelationshipManager._ObjectRelationships.ContainsKey(objectType)
                ? RelationshipManager._ObjectRelationships[objectType]
