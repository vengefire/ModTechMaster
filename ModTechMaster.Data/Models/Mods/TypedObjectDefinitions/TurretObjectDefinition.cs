...
namespace ModTechMaster.Data.Models.Mods.TypedObjectDefinitions
{
    public class TurretObjectDefinition : ObjectDefinition
    {
        ...
        {
            base.AddMetaData();
            var componentIdList = new List<string>();
            MetaData.Add(Keywords.ComponentDefId, componentIdList);
            foreach (var item in JsonObject.inventory) componentIdList.Add(item.ComponentDefID.ToString());
